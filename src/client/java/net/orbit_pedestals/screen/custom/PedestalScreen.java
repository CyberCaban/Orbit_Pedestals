package net.orbit_pedestals.screen.custom;
...
import net.orbit_pedestals.network.UpdatePedestalFloatPayload;
import net.orbit_pedestals.network.UpdatePedestalVec3dPayload;
import net.orbit_pedestals.screen.widget.NumericInputWidget;
