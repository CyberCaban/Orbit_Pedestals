package net.orbit_pedestals.block.entity.custom;
...
import net.orbit_pedestals.block.entity.ImplementedInventory;
import net.orbit_pedestals.block.entity.ModBlockEntities;
import net.orbit_pedestals.screen.custom.PedestalScreenHandler;
import org.jetbrains.annotations.Nullable;

import java.util.stream.Collectors;

import static net.orbit_pedestals.block.entity.custom.PedestalRenderConfig.Builder.configToBuilder;
