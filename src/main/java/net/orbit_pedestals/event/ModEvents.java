package net.orbit_pedestals.event;

import net.minecraft.component.ComponentType;
import net.minecraft.item.ItemStack;
import net.minecraft.server.MinecraftServer;
import net.minecraft.server.network.ServerPlayerEntity;
import net.orbit_pedestals.item.custom.ability.AoWAbilities;
import net.orbit_pedestals.item.custom.ability.AshAbility;

import java.util.HashMap;
import java.util.Map;
import java.util.UUID;

import static net.orbit_pedestals.item.ModComponents.*;
